      ...
      <div className="bg-white rounded-2xl border border-black/10 shadow-xl p-10 sm:p-16 w-full">
        ...
        <section className="space-y-6 text-black/70 text-lg leading-relaxed">
          ...
          <ul className="list-disc list-inside space-y-2 ml-5">
            ...
            <li>
              <strong>Shopping:</strong> Users are encouraged to buy genuine WHIZROBO Products from this website. Please read Refund & Cancellation terms before purchasing.
            </li>
            <li>
              <strong>User Data:</strong> We protect user personal data. Please check the Privacy Policy for more information.
            </li>
            <li>
              <strong>General Rules:</strong> Visitors may not use the Website to transmit, distribute, store, or destroy material that is illegal, infringes IP rights, or is offensive.
            </li>
            <li>
              <strong>Virtual League & Rewards:</strong> Participation in paid virtual competitions is at the user’s discretion. Company ensures transparency, but results may vary depending on technology.
            </li>
          </ul>
