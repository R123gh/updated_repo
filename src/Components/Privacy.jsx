...
const Privacy = () => {
  return (
    <div className="min-h-screen bg-white py-16 px-6 md:px-12 lg:px-16">
      ...
      {/* Page Heading */}
      <h1 className="text-4xl md:text-5xl font-extrabold text-black text-center mb-12">
        Privacy Policy
      </h1>
      ...
      <div className="space-y-8 text-black/70 leading-relaxed">
        ...
        <h2 className="text-2xl font-bold text-black mt-8">1. Collection of Information</h2>
        <p>
          We may collect the following information from users:
        </p>

        <h3 className="text-xl font-semibold mt-4 text-black">1.1 Personal Information</h3>
        <p>
        ...
        <h3 className="text-xl font-semibold mt-4 text-black">1.2 Non-Personal Information</h3>
        <p>
        ...
        <h2 className="text-2xl font-bold text-black mt-8">2. Representation and Warranties</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-black mt-8">5. Third-Party Website Links</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-black mt-8">6. Protection of Information</h2>
        <p>
        ...
        <h2 className="text-2xl font-bold text-black mt-8">7. Withdrawal of Information</h2>
        <p>
          Users may withdraw information at any time by contacting the grievance officer via email.
        </p>

        <h2 className="text-2xl font-bold text-black mt-8">8. Grievance Redressal</h2>
        <p>
          For privacy complaints, users may contact: <br />
          <strong>Email:</strong>{" "}
          <a href="mailto:info@whizrobo.com" className="text-[#EC7B21] hover:underline">
            info@whizrobo.com
          </a>
        </p>

        <h2 className="text-2xl font-bold text-black mt-8">9. Video Content</h2>
        <p>
          Video content is hosted on AWS Cloud Services and adheres to the AWS Privacy Policy.
        </p>

        <h2 className="text-2xl font-bold text-black mt-8">10. Changes to Policy</h2>
        <p>
