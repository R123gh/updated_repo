        ...
        <div className={`flex flex-col min-h-screen ${isDark ? "bg-black text-white" : "bg-white text-black"}`}>
          ...
          >
            <div className="max-w-7xl mx-auto px-6 py-12 lg:py-16">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 text-center md:text-left">
                <div className="lg:col-span-4">
                  ...
                  <p className="mt-4 text-xs uppercase tracking-[0.2em] text-white/50">
                    Friendly Tech · Practical Robotics · Clean Design
                  </p>
                </div>
                ...
                <div className="lg:col-span-5">
                  ...
                  <div className="text-sm text-white/80 leading-relaxed">
                    ...
                    <p className="mt-1">
                      Phone: <a href="tel:+918968714000" className="hover:text-[#EC7B21] transition">+91-896-871-4000</a>
                    </p>
                  </div>
                </div>
              </div>
